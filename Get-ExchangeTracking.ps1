...
# Source ID: e980eb3e-c21a-46d5-81a4-ce1345d6c8c4
#------------------------------------------------------------------------
<#
    .NOTES
    --------------------------------------------------------------------------------
     Code generated by:  Emre YILMAZ
     Generated on:       01/14/2020 14:00
     Generated by:       Emre YILMAZ
     Organization:       http://www.emreyilmaz.istanbul
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
function Show-MainForm_psf
{
	...
	$MainForm_Load = {
		...
		# Specify default maximum number of results
		#$global:resultLimit = $txt_ResultsLimit.Text
	}
	...
	function Get-TrackInfo
	{
		...
		if ($HubServer)
		{
			...
			$global:trackingCommand = "Get-TransportService '$HubServer' | Get-MessageTrackingLog -WarningAction Continue -ResultSize $resultLimit"
			
		}
		else
		{
			# If nothing is specified get all tracking logs - limit to 300 for perforamnce reasons
			$global:trackingCommand = "Get-TransportService | Get-MessageTrackingLog -WarningAction Continue -ResultSize $resultLimit"
		}
	...
	#region Test IP Address function
	function Test-IPAddress
	{
		...
		# Check if input field in the server textbox is an IP Address or Server Name
		$ipReg = [regex]"^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$"
		if ($ipReg.IsMatch($IpAddress) -eq $true)
		{
			$result = ([System.Net.Dns]::GetHostEntry($IpAddress)).HostName.ToString()
			$txt_Server.Text = $result
		}
	} #endregion
	...
	$btn_Track_Click = {
		...
		# Check the value of ResultSize textbox
		if ($txt_ResultsLimit.Text -eq 0)
		{
			$global:resultLimit = "Unlimited"
		}
		else
		{
			$global:resultLimit = $txt_ResultsLimit.Text
		...
		Get-TrackInfo
		Invoke-Expression $trackingCommand |
		Select-Object Timestamp, EventId, Soruce, Sender, Recipients, MessageSubject, RecipientStatus |
	...
	$txt_Server_Leave = {
		# Check if user inserted an IP in place of the server's name
		Test-IPAddress -IpAddress $txt_Server.Text
	...
	$Form_StoreValues_Closing =
	{
		...
		$script:MainForm_txt_ResultsLimit = $txt_ResultsLimit.Text
	...
	$Form_Cleanup_FormClosed =
	{
		...
		try
		{
			...
			$txt_Server.remove_Leave($txt_Server_Leave)
...
//////////////////////////////////////////////////////////8=')
	...
	$MainForm.Text = 'Emre YILMAZ | www.emreyilmaz.istanbul'
...
function Show-About_psf
{
	...
	$form_About_Load = {
		...
		$global:appName = "Mail Tr@cker"
		$appVersion = "1.2"
		$appLastUpdate = "Last Update: 2020/01/14"
		
		# Author Information
		$authorName = "Emre YILMAZ"
		$authorMail = "emreyilmaz1907@gmail.com"
		$authorBlog = "www.emreyilmaz.istanbul"
		$global:authorBlogURL = "http://www.emreyilmaz.istanbul"
		$global:authorTwitter = "https://twitter.com/EmreYILMAZ1907"
		$global:globalauthorTwitterURL = "https://twitter.com/EmreYILMAZ1907"
		$global:authorLinkedIn = "https://tr.linkedin.com/in/emre-yilmaz-73749085"
	...
	$form_About.AutoScaleDimensions = '8, 17'
	$form_About.AutoScaleMode = 'Font'
	$form_About.ClientSize = '458, 349'
...
//////////////////////////////////////////////////////////8=')
	...
	# lbl_LinkedIn
	#
	$lbl_LinkedIn.Location = '106, 258'
	$lbl_LinkedIn.Margin = '5, 0, 5, 0'
	$lbl_LinkedIn.Name = 'lbl_LinkedIn'
	$lbl_LinkedIn.Size = '448, 33'
	...
	$labelLinkedIn.Location = '16, 251'
	$labelLinkedIn.Margin = '4, 0, 4, 0'
	$labelLinkedIn.Name = 'labelLinkedIn'
	$labelLinkedIn.Size = '82, 30'
	...
	# lbl_BlogUrl
	#
	$lbl_BlogUrl.Location = '106, 228'
	$lbl_BlogUrl.Margin = '5, 0, 5, 0'
	$lbl_BlogUrl.Name = 'lbl_BlogUrl'
	$lbl_BlogUrl.Size = '448, 33'
	...
	$labelBlog.Location = '16, 221'
	$labelBlog.Margin = '4, 0, 4, 0'
	$labelBlog.Name = 'labelBlog'
	$labelBlog.Size = '68, 30'
	...
	# lbl_Twitter
	#
	$lbl_Twitter.Location = '106, 196'
	$lbl_Twitter.Margin = '5, 0, 5, 0'
	$lbl_Twitter.Name = 'lbl_Twitter'
	$lbl_Twitter.Size = '448, 33'
	...
	$labelTwitter.Location = '14, 194'
	$labelTwitter.Margin = '4, 0, 4, 0'
	$labelTwitter.Name = 'labelTwitter'
	$labelTwitter.Size = '82, 24'
	...
	$labelEmail.Location = '16, 162'
	$labelEmail.Margin = '4, 0, 4, 0'
	$labelEmail.Name = 'labelEmail'
	$labelEmail.Size = '82, 29'
	...
	$labelLbl_AppAuthor.Location = '16, 128'
	$labelLbl_AppAuthor.Margin = '4, 0, 4, 0'
	$labelLbl_AppAuthor.Name = 'labelLbl_AppAuthor'
	$labelLbl_AppAuthor.Size = '426, 25'
	...
	# lbl_CreatedWith
	#
	$lbl_CreatedWith.Location = '16, 77'
	$lbl_CreatedWith.Margin = '5, 0, 5, 0'
	$lbl_CreatedWith.Name = 'lbl_CreatedWith'
	$lbl_CreatedWith.Size = '442, 67'
	...
	$labelLbl_AppUpdate.Location = '16, 37'
	$labelLbl_AppUpdate.Margin = '4, 0, 4, 0'
	$labelLbl_AppUpdate.Name = 'labelLbl_AppUpdate'
	$labelLbl_AppUpdate.Size = '426, 25'
	...
	$lbl_AppAbout.Location = '16, 12'
	$lbl_AppAbout.Margin = '4, 0, 4, 0'
	$lbl_AppAbout.Name = 'lbl_AppAbout'
	$lbl_AppAbout.Size = '426, 25'
	...
	$linklabelEmail.Margin = '5, 0, 5, 0'
	$linklabelEmail.Name = 'linklabelEmail'
	$linklabelEmail.Size = '448, 31'
	...
	#
	$btn_Ok.Dock = 'Bottom'
	$btn_Ok.Location = '0, 319'
	$btn_Ok.Margin = '4, 4, 4, 4'
	$btn_Ok.Name = 'btn_Ok'
	$btn_Ok.Size = '458, 30'
	$btn_Ok.TabIndex = 0
	$btn_Ok.Text = 'OK'
